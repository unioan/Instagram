...
extension UIViewController {
    ...
    func configureGradientLayer() {
        ...
        gradient.locations = [0, 1] // 0 где начинается, 1 где заканчивается / если мы хотим чтобы гардиент закончился на середине то второе значение должно быть 0.5
...
extension UIButton {
    func attributedTitle(firstPart: String, secondPart: String) {
        ...
        let boldAttributes: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor(white: 1, alpha: 0.87),
    ...
    func authButtonTitle(_ text: String) {
